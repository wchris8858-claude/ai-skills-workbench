-- 删除现有策略(如果存在)
DROP POLICY IF EXISTS "Allow admin to read system_settings" ON system_settings;
DROP POLICY IF EXISTS "Allow admin to insert system_settings" ON system_settings;
DROP POLICY IF EXISTS "Allow admin to update system_settings" ON system_settings;
DROP POLICY IF EXISTS "Allow admin to delete system_settings" ON system_settings;
